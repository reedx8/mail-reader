...
If you instead want to run via an emulator, run `npm run ios` (Xcode) or `npm run android` (Android Studio). See https://docs.expo.dev/get-started/set-up-your-environment/
